...
device='cuda'
inputpath="NN/ISTDNN/"
outputpath="NN/FSTDNN_csv/"
def loaddata(inputpath,outputpath):

    datapath="pm+gwr_day+time+ev.csv"
    ...
    #model_load
    models=[]
    model_1=torch.load(inputpath+"ISTDNN4_sample1.pt")
    model_2=torch.load(inputpath+"ISTDNN4_sample2.pt")
    model_3=torch.load(inputpath+"ISTDNN4_sample3.pt")
    model_4=torch.load(inputpath+"ISTDNN4_sample4.pt")
    model_5=torch.load(inputpath+"ISTDNN4_sample5.pt")
    model_6=torch.load(inputpath+"ISTDNN4_sample6.pt")
    ...
    result.to_csv(outputpath+'result_4.csv',index=False)
    ...
    result_metrics.to_csv(outputpath+"result_metrics_4.csv",index=False)
