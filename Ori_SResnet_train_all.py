...
def sample_train(epoch_num,learningrate,batchsize,device):
    ...
    for train,test in kf.split(df):
        ...
        #load data
        train_dataset = Ori_Resnet_dataset(train_data)
        test_dataset = Ori_Resnet_dataset(test_data)
        #loader
        ...
        for i in range(epoch+1):
            ...
            with torch.no_grad():
                ...
                if Epoch_list[-1] % 10 == 0:
                    print("epoch: {}, test R2:{},RMSE:{}".format(Epoch_list[-1], test_r2_list[-1], test_rmse_list[-1]))
    ...
    print("10 folds CV R2:{},    RMSE:{}".format(final_test_r2, final_test_rmse))

    print("10 folds max_train R2:{},    RMSE:{}".format(final_max_train_r2, final_max_train_rmse))
    print("10 folds max_CV R2:{},    RMSE:{}".format(final_max_test_r2, final_max_test_rmse))
...
def station_train(epoch_num,learningrate,batchsize,device):
    ...
    n = 0
    kf = KFold(n_splits=10, shuffle=True, random_state=345)  # station cv
